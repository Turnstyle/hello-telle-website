        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="card text-center p-8">
              ...
              <p className="text-slate-600 mb-4">Send us an email and we&rsquo;ll respond within 24 hours.</p>
              <a href="mailto:support@hellotelle.com" className="btn-secondary inline-flex justify-center">
                Send Email
              </a>
            </div>
          </div>
          ...
          <div className="card mt-8 p-8">
            ...
            <p className="text-slate-600 mb-4">Check out our FAQ page for quick answers to common questions.</p>
